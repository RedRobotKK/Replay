...
2. `replay cost ~/.claude/projects/`. Quote the Calibration line first. If the match rate is low, say so and stop. Then the total, the median task, the p90, and the re-billed line with its date.
