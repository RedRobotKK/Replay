...
Coming: Homebrew tap, .deb on the release page, .rpm on the release page, .apk on the release page, Arch AUR (replay-doctor-bin), npm (npx), PyPI (uvx / pipx), bunx / deno (via npm).
