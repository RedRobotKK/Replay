...
Start here:
  ...
  replay codex  <dir...>           OpenAI Codex rollout logs: tokens, never dollars
  replay grok   <dir...>           Grok sessions: tokens, and why it prints no money
  replay burn                      what each surface burned: Codex, Grok, Ollama, Claude Code
