...
| [**What the week costs to produce**](week-pricing-model.md) | The hours behind the forensics week, the cost floor, the capacity ceiling, and what the fee is a fraction of | **Loaded 45 to 57 hours against 34 billed, a 1.32x to 1.68x ratio.** Machine time is 16 seconds, so the sale is attribution and a defensible document. The buyer needs roughly eight metered operators or the fee is a double-digit share of their bill |
