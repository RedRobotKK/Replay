...
| [**Pre-tag review, 2026-09-13**](pre-tag-review-2026-09-13.md) | What three adversarial reviews found before the v0.6.0 tag, what was fixed, and what was deliberately left | **The shim workflow would have fired zero times**; the corpus silent zero survived inside its own fix; the cosign exec pin constrained nothing. Three open items, none blocking the tag |
| [**What the week costs to produce**](week-pricing-model.md) | The hours behind the forensics week, the cost floor, the capacity ceiling, and what the fee is a fraction of | **$22,000 flat, quoted $18,000 to $25,000.** Loaded 45 to 57 hours against 34 billed; machine time is 16 seconds, so the sale is attribution and a document. Cost floor and market comparables (Percona $11,400, Runtime Verification $20,000/wk, Trail of Bits $25,000/engineer-wk) overlap at $17,500 to $25,000. **Section 6 was wrong by 48x to 80x on first writing and says so**: the buyer is 60 to 135 developers at ordinary spend, or ten in the heavy-usage tail |
