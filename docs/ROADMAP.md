...
| 2 | Does the replay engine reproduce as-run cache reads and writes? | At least 95 percent of turns across 20 sessions, mismatches explained. **Status:** 97.32% (26,571/27,302 turns) across 1363 real sessions ([corpus](evidence/calibration-corpus-2026-09-05.md)); the 429 sessions below the threshold are listed rather than dropped. The session count is met many times over; independence is not, because all of them come from one machine |
